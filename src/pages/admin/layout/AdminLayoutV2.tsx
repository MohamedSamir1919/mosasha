        ...
        <div className="sidebar-inner">
          ...
          <div className="sidebar-logo">
            <div className="peers ai-c fxw-nw">
              <div className="peer peer-greed">
                <NavLink className="sidebar-link td-n" href="index.html">
                  <div className="peers ai-c fxw-nw">
                    <div className="peer">
                      <div className="logo">
          ...
          <ul className="sidebar-menu scrollable pos-r">
            <li className="nav-item mT-30 actived">
              <NavLink className="sidebar-link" href="index.html">
            ...
            <li className="nav-item">
              <NavLink className='sidebar-link' href="email.html">
                <span className="icon-holder">
            ...
            <li className="nav-item">
              <NavLink className='sidebar-link' href="compose.html">
                <span className="icon-holder">
            ...
            <li className="nav-item">
              <NavLink className='sidebar-link' href="calendar.html">
                <span className="icon-holder">
            ...
            <li className="nav-item">
              <NavLink className='sidebar-link' href="chat.html">
                <span className="icon-holder">
            ...
            <li className="nav-item">
              <NavLink className='sidebar-link' href="charts.html">
                <span className="icon-holder">
            ...
            <li className="nav-item">
              <NavLink className='sidebar-link' href="forms.html">
                <span className="icon-holder">
            ...
            <li className="nav-item dropdown">
              <NavLink className="sidebar-link" href="ui.html">
                <span className="icon-holder">
            ...
            <li className="nav-item dropdown">
              <NavLink className="dropdown-toggle" href="javascript:void(0);">
                <span className="icon-holder">
              ...
              <ul className="dropdown-menu">
                <li>
                  <NavLink className='sidebar-link' href="basic-table.html">Basic Table</NavLink>
                </li>
                <li>
                  <NavLink className='sidebar-link' href="datatable.html">Data Table</NavLink>
                </li>
              </ul>
            </li>
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li>
                  <NavLink href="google-maps.html">Google Map</NavLink>
                </li>
                <li>
                  <NavLink href="vector-maps.html">Vector Map</NavLink>
                </li>
              </ul>
            </li>
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li>
                  <NavLink className='sidebar-link' href="blank.html">Blank</NavLink>
                </li>                 
                <li>
                  <NavLink className='sidebar-link' href="404.html">404</NavLink>
                </li>
                <li>
                  <NavLink className='sidebar-link' href="500.html">500</NavLink>
                </li>
                <li>
                  <NavLink className='sidebar-link' href="signin.html">Sign In</NavLink>
                </li>
                <li>
                  <NavLink className='sidebar-link' href="signup.html">Sign Up</NavLink>
                </li>
              </ul>
            </li>
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <NavLink href="javascript:void(0);">Menu Item</NavLink>
                    </li>
                    <li>
                      <NavLink href="javascript:void(0);">Menu Item</NavLink>
                    </li>
            ...
            {/* <!-- ### $Topbar ### --> */}
                    ...
                    <div className="header-container">
                        ...
                        <li>
                            <NavLink id='sidebar-toggle' className="sidebar-toggle" href="javascript:void(0);">
                        ...
                        <li className="notifications dropdown">
                            ...
                            <NavLink href="" className="dropdown-toggle no-after" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <li>
                                ...
                                <li>
                                    <NavLink href="" className='peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100'>
                            ...
                            <li className="pX-20 pY-15 ta-c bdT">
                                <span>
                                <NavLink href="" className="c-grey-600 cH-blue fsz-sm td-n">View All Notifications <i className="ti-angle-right fsz-xs mL-10"></i></NavLink>
                                </span>
                            </li>
                            </ul>
                        </li>
                        <li className="notifications dropdown">
                            ...
                            <NavLink href="" className="dropdown-toggle no-after" data-bs-toggle="dropdown">
                            ...
                            <li className="pX-20 pY-15 ta-c bdT">
                                <span>
                                <NavLink href="email.html" className="c-grey-600 cH-blue fsz-sm td-n">View All Email <i className="fs-xs ti-angle-right mL-10"></i></NavLink>
                                </span>
                            </li>
                            </ul>
                        </li>
                        <li className="dropdown">
                            <NavLink href="" className="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-bs-toggle="dropdown">
                            ...
                            <li>
                                <NavLink href="" className="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
                            ...
                            <li>
                                <NavLink href="email.html" className="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
